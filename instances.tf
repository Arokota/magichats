...
provisioner "local-exec" {
  command = "sleep 30; ANSIBLE_HOST_KEY_CHECKING=false ansible-playbook -u ubuntu -i '${self.public_ip},' --private-key ${var.ssh-privkey} ansible/setup-socat.yml -e 'c2=${aws_instance.MH-C2-SERVER.private_ip}'"
}
